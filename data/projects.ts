...
export const projects: Project[] = [
  {
    ...
    bullets: [
      ...
      "Fade timeline is independent of video playback: driven by clock time, so it doesn't drift on video loops or when its tab is backgrounded",
      "Duration and video ID persisted in the URL. Shareable and bookmark-friendly",
